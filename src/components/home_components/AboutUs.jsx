...
export const homeSectionPadding = "py-10 px-5 sm:px-10 md:px-13 lg:p-20"

const AboutUs = () => {
  return (
    <>
      <section className={`bg-[var(--text-secondary-light)] w-full min-w-screen flex flex-col-reverse ${homeSectionPadding} md:flex-row gap-10`}>
