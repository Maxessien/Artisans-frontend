  ...
  return (
    <footer className="w-full bg-[var(--text-secondary-light)] text-[var(--text-primary-light)] px-6 md:px-12 lg:px-20 py-12">
      <div
        ...
        } md:grid-cols-3 lg:grid-cols-5 gap-10`}
      >
        {/* Brand Section */}
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li>
              <Link href="/help-center">Help Centre / Support</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm">
            Email:{" "}
            <a href="mailto:support@brand.com" className="underline">
              support@brand.com
            </a>
          </p>
          <p className="text-sm">
            Phone:{" "}
            <a href="tel:+234xxxxxxxxx" className="underline">
              +234 xxx xxx xxx
            </a>
          </p>
